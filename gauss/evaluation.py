...
if reference_image is None:
    ...
    images_to_compare = ['lena_gauss_processed.jpg']
...
## lena
# Metrics for lena_local_mean.jpg:
# MSE: 58.54, PSNR: 30.46, SSIM: 0.6292

# Metrics for lena_non_local_means.jpg:
# MSE: 44.92, PSNR: 31.61, SSIM: 0.7385

# Metrics for lena_bilateral.jpg:
# MSE: 77.17, PSNR: 29.26, SSIM: 0.4450


## bird
# Metrics for bird_local_mean.jpg:
# MSE: 33.14, PSNR: 32.93, SSIM: 0.7020

# Metrics for bird_non_local_means.jpg:
# MSE: 16.08, PSNR: 36.07, SSIM: 0.8947

# Metrics for bird_bilateral.jpg:
# MSE: 33.26, PSNR: 32.91, SSIM: 0.6815